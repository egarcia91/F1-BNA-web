...
function IconoGoogle() {
  return (
    <svg className={styles.iconoGoogle} viewBox="0 0 24 24" aria-hidden>
  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.card}>
        <h1 className={styles.titulo}>Karting BNA</h1>
        <p className={styles.subtitulo}>
          Iniciá sesión con tu cuenta de Google para acceder
        </p>
        {!clientId && (
          <p className={styles.avisoConfig}>
        ...
        <button
          ...
          className={styles.botonInvitado}
